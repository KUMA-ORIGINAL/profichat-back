...
RAVEN_API_URL = env("RAVEN_API_URL", default="https://raven.operator.kg/api/v1")
RAVEN_API_KEY = env("RAVEN_API_KEY")
...
TELEGRAM_AUTH_BOT_TOKEN = env('TELEGRAM_AUTH_BOT_TOKEN', default=TELEGRAM_BOT_TOKEN)
TELEGRAM_AUTH_WEBHOOK_SECRET = env('TELEGRAM_AUTH_WEBHOOK_SECRET', default='')
...
TEST_SHORT_TOKEN_USER_IDS = {
    int(user_id)
    for user_id in env.list("TEST_SHORT_TOKEN_USER_IDS", default=[])
}
TEST_SHORT_ACCESS_TOKEN_LIFETIME_SECONDS = env.int("TEST_SHORT_ACCESS_TOKEN_LIFETIME_SECONDS", default=60)
TEST_SHORT_REFRESH_TOKEN_LIFETIME_SECONDS = env.int("TEST_SHORT_REFRESH_TOKEN_LIFETIME_SECONDS", default=300)

SECOND_SYSTEM_WEB_URL = env("SECOND_SYSTEM_WEB_URL", default="")
SECOND_SYSTEM_INTEGRATION_SECRET = env("SECOND_SYSTEM_INTEGRATION_SECRET", default="")
SECOND_SYSTEM_SSO_TTL_SECONDS = env.int("SECOND_SYSTEM_SSO_TTL_SECONDS", default=120)
